...
3、如果这两个对象完全相同，返回true，否则，返回false，问题又来了，JS里的对象是引用类型，不管两个对象内容是否一致，它们是始终不相等的
...
多说一句，第16行的var hash1 = {}, hash2 = {} 其实也可以换成
var hash1 = [], hash2 = []，因为js里数组的下标也可以是字符串
例如var arr = []; arr['a'] = 1 是合法的
但是我们要避免这种做法，由于某种特殊原因，比如arr['3'] = 1的时候，
arr为[ undefined, undefined, undefined, 1 ]，会浪费额外的内存空间
